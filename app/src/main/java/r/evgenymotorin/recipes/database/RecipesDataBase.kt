...
import r.evgenymotorin.recipes.database.tables.*
import r.evgenymotorin.recipes.db.tables.RecipeData

@Database(entities = [RecipeData::class, StepData::class, AboutImageData::class, AdaptiveIngredientData::class, FavouritesData::class, SearchHistoryData::class], version = 1)
